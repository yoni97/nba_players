...
class Player(db.Model):
    ...
    age = db.Column(db.Integer(80), nullable=False)
    ...
    fieldPercent = db.Column(db.Integer)
    threeFg = db.Column(db.Integer)
    threeAttempts = db.Column(db.Integer)
    threePercent = db.Column(db.Integer)
    twoFg = db.Column(db.Integer)
    twoAttempts = db.Column(db.Integer)
    twoPercent = db.Column(db.Integer)
    effectFgPercent = db.Column(db.Integer)
    ft = db.Column(db.Integer)
    ftAttempts = db.Column()
    ftPercent = db.Column(db.Integer)
